...
export const I18N = {
  en: {
    ...
    joinLead: "Enter your name to get your room and mission.",
  ...
  id: {
    ...
    joinLead: "Masukin nama kamu buat dapetin room dan misi kamu.",
    joinBtn: "Gabung & Buka Mission Card",
    namePlaceholder: "Nama kamu",
    shuffling: "Mengocok berkas misi…",
    tap: 'Tap untuk <b>buka</b>',
    ...
    errBody: "Server misi nggak kejangkau. Cek koneksi kamu lalu tap untuk coba lagi.",
    retry: "Coba lagi",
